...
// --- русский блок ---
children.push(center([run('Каталог из 84 численных форматов с битоточными векторами соответствия:', { bold: true, size: 28 })], { after: 0 }));
...
children.push(center([run('e-mail: dao999nft@gmail.com   |   ORCID: 0009-0008-4294-6159', { size: 22 })], { after: 160 }));
...
// --- английский блок ---
children.push(center([run('An 84-format numeric catalog with bit-exact conformance vectors:', { bold: true, size: 28 })], { after: 0 }));
...
const doc = new Document({
  ...
  title: 'Титульный лист — Каталог 84 форматов',
