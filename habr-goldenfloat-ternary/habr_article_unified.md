...
![φ-якорь семейства: тождество, числа Люка, константа-семя](uni_1_anchor.png)
...
![Один закон порождает всю лестницу форматов](uni_2_ladder.png)
...
![GF16: эталон, измеренный замер, честная рамка](uni_3_gf16.png)
...
![Сетунь 1958, трит и изящество балансной троичности](uni_4_setun.png)
...
![Возвращение троичности: веса LLM, безмультипликаторность, золотой 2-битный предел](uni_5_return.png)
