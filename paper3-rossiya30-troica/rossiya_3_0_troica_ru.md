...
## 4a. Киллер-фича: единая программная модель — один код от CPU-эмуляции до кремния
...
Предлагаемая **четырёхуровневая трассировка энергии \(J/\text{op}\)** — прямое расширение киллер-фичи на энергометрику:
